        ...
        return(
          <div>
            <div className="container company-bottom-margin">
              ...
              {/*<p className="news-body-text-container" dangerouslySetInnerHTML={{__html: this.state.newJobsArray.text}}>
              </p>*/}
                  <h2>The standard Lorem Ipsum passage, used since the 1500s</h2><p>
                  ...
                  <h2>
                  Section 1.10.33 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC</h2>
                  <p>
